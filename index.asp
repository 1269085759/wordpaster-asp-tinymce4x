...
<body>
	...
	<script language="javascript" type="text/javascript">
		...
		pasterMgr.Config["PostUrl"] = "http://localhost:90/asp/upload.asp";
		pasterMgr.Config["Cookie"] = 'ASPSESSIONID=<%=Session.SessionID%>';
		//pasterMgr.Config["PostUrl"] = "http://localhost/test/asp/upload.asp";
		//pasterMgr.Config["PostUrl"] = "http://localhost:81/wordpaster/upload.php";
		//pasterMgr.Config["PostUrl"] = "http://localhost:8080/WordPaster/upload.jsp";
		pasterMgr.Load();//加载控件
